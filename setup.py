...
setuptools.setup(
    ...
    extras_require={
        ...
        "test": [
            ...
            "torch",
            "torchvision",
            "catboost>=0.26; python_version<'3.14'",
            "rgf-python",
            "optuna>=2.8.0,<=3.6.1",
            ...
            "mlflow-skinny<=2.12.2; python_version<'3.12'",
            "mlflow-skinny<=2.18.0; python_version>='3.12' and python_version<'3.13'",
            "mlflow-skinny<=2.22.1; python_version>='3.13'",
            "joblibspark>=0.5.0",
            "joblib<=1.3.2",
            "nbconvert",
            "nbformat",
