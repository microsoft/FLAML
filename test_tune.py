...
def train_breast_cancer(config: dict):
    ...
    print("-----------------------------------------")
    if config["incumbent_info"] != None:
        print(config["incumbent_info"]["incumbent_result"]) 
        print(config["incumbent_info"]["incumbent_config"])
    print("-----------------------------------------")
    del config["incumbent_info"]
