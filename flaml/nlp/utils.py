...
def load_dft_args():
    ...
    arg_parser.add_argument('--seed_np', type=int, help='seed of numpy', required=False, default=42)
    arg_parser.add_argument('--seed_bs', type=int, help='seed of bs', required=False, default=42)
