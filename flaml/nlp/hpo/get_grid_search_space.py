...
def get_deberta_space(
    ...
    return get_space_union_and_unique(
        search_space_common, search_space_unique, [model_size_type]
    )
...
def get_funnel_space(
    ...
    search_space_unique = {
        "imdb": {"per_device_train_batch_size": [32], "num_train_epochs": [5]},
        "ag_news": {"per_device_train_batch_size": [32], "num_train_epochs": [3]},
        "dbpedia_14": {"per_device_train_batch_size": [64], "num_train_epochs": [3]},
        "yelp_polarity": {
        ...
        "glue_rte": {"per_device_train_batch_size": [16], "num_train_epochs": [10]},
        "glue_mrpc": {"per_device_train_batch_size": [16], "num_train_epochs": [10]},
        "glue_stsb": {"per_device_train_batch_size": [16], "num_train_epochs": [10]},
        "glue_cola": {"per_device_train_batch_size": [16], "num_train_epochs": [10]},
        "glue_sst2": {"per_device_train_batch_size": [32], "num_train_epochs": [5]},
        "glue_qnli": {"per_device_train_batch_size": [32], "num_train_epochs": [3]},
        "glue_mnli": {"per_device_train_batch_size": [64], "num_train_epochs": [3]},
        "glue_qqp": {"per_device_train_batch_size": [64], "num_train_epochs": [5]},
    }
...
def get_electra_space(
    ...
    search_space_unique = {
        ...
        "squad": {"num_train_epochs": [2]},
        "squad_v2": {"num_train_epochs": [2]},
        "glue_stsb": {
            "num_train_epochs": [10],
        },
        "glue_rte": {
