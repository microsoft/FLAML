                    ...
                    for label in missing_in_train:
                        ...
                        if num_instances == 1:
                            ...
                            if "sample_weight" in state.fit_kwargs:
                                ...
                                if sample_weight_source is not None and label_indices[0] < len(sample_weight_source):
                                    ...
                                    state.fit_kwargs["sample_weight"] = concat(
                                        single_weight, state.fit_kwargs["sample_weight"]
                                    )
                        else:
                            ...
                            if len(remaining_indices) > 0:
                                ...
                                y_val = (
                                    concat(y_remaining, y_val) if data_is_df else np.concatenate([y_remaining, y_val])
                                )
                            ...
                            if "sample_weight" in state.fit_kwargs:
                                ...
                                if sample_weight_source is not None and max(indices_to_move) < len(
                                    sample_weight_source
                                ):
                                    weights_to_move = (
                        ...
                        if num_instances == 1:
                            ...
                            if len(remaining_indices) > 0:
                                ...
                                y_train = (
                                    ...
                                    if data_is_df
                                    else np.concatenate([y_remaining, y_train])
                                )
                                ...
                                if sample_weight_source is not None and max(indices_to_move) < len(
                                    ...
                                    if len(remaining_indices) > 0:
                                        ...
                                        if isinstance(state.fit_kwargs["sample_weight"], np.ndarray):
                                            state.fit_kwargs["sample_weight"] = state.fit_kwargs["sample_weight"][
                                                train_mask
                                            ]
                                        else:
                                            state.fit_kwargs["sample_weight"] = state.fit_kwargs["sample_weight"][
