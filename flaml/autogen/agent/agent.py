...
class Agent:
    ...
    def receive(self, message: Union[Dict, str], sender: "Agent"):
        ...
        In the subclass, call `super().receive(message, sender)` first.
        ...
        # After the above, perform actions based on the message
        # Define the actions in a subclass.
    ...
    def _ai_reply(self, sender) -> Union[str, Dict]:
    ...
    def auto_reply(self, sender: "Agent") -> Union[str, Dict]:
        """Reply to the sender based on the conversation history.

        Default reply is generated by LLM.
        ...
        Returns:
            str or dict: reply to the sender.
        """
        return self._ai_reply(sender)
