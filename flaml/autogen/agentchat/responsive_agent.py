...
class ResponsiveAgent(Agent):
    ...
    def _append_oai_message(
        ...
        Args:
            ...
            role (str): role of the message. It can be "assistant", "user" or "function". It will be used to overwrite the "role" in the message only when original role is not "function".
