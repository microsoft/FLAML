...
def test_flaml_raytune_consistency(num_samples=-1, max_concurrent_trials=1, searcher_name='cfo'):
    np.random.seed(100)
...
if __name__ == "__main__":
    # unittest.main()
    test_flaml_raytune_consistency(num_samples=5, max_concurrent_trials=1, searcher_name='random')
    test_flaml_raytune_consistency(num_samples=5, max_concurrent_trials=1, searcher_name='cfo')
    test_flaml_raytune_consistency(num_samples=5, max_concurrent_trials=1, searcher_name='bs')
