...
1. For common machine learning or AI tasks like classification, regression and generation, it quickly finds quality models for user-provided data with low computational resources. t supports both classical machine learning models and deep neural networks, including large language models.
