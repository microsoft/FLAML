...
#### **Guidelines on how to set the hyperparameter search space**
...
- Caveats: When the search space consists of a set of integers without order, you should use first convert integers to str and then use `tune.choice()`.
