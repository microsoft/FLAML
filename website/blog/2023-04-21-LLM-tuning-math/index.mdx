...
![level 2 algebra\label{level2}](img/level2algebra.png)
...
Figure \ref{level2} shows the average accuracy and average inference cost of each configuration on the level 2 Algebra test set.
...
![level 3 algebra\label{level3}](img/level3algebra.png)

However, the selected model changes on level 4 Algebra.

![level 4 algebra\label{level4}](img/level4algebra.png)
...
![level 5 algebra\label{level5}](img/level5algebra.png)
