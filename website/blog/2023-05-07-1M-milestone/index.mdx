...
authors: qingyunwu
tags: [LLM, LLMOps, FLAML-v2]
---

**TL;DR:**
* **1 million downloads milestone of FLAML**
* **LLM support in FLAML v2.**


This week, FLAML has reached a significant milestone: 1 million downloads. Originating as a intern research project within Microsoft Research, FLAML has grown into an open-source library used widely across the industry and supported by an active community. To mark this milestone, we'd like to take the opportunity to reflect on FLAML's past achievements and its future roadmap, with a particular focus on large language models (LLM) and LLMOps.
## FLAML's Past Achievements

### Off-the-Shelf AutoML at Your Fingertips
