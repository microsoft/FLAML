...
A big shoutout to our industrial collaborators from Azure Compute, Azure Data (@thinkall), Azure Machine Learning, Microsoft 365, ML.NET, Vowpal Wabbit, Anyscale, Databricks, and Wise; and academic collaborators from MIT, Penn State University, Stevens Institute of Technology, Tel Aviv University, Texas A & M University, University of Manchester, University of Washington, and The Chinese University of Hong Kong etc.
...
What sets FLAML apart from other AutoML libraries is its efficiency. Both [`flaml.tune`](https://microsoft.github.io/FLAML/docs/Use-Cases/Tune-User-Defined-Function) and [flaml.AutoML](https://microsoft.github.io/FLAML/docs/Use-Cases/Task-Oriented-AutoML) are fast, thanks to efficient hyperparameter optimization and model selection methods. FLAML is also capable of handling large search spaces with heterogeneous evaluation costs, complex constraints, guidance, and early stopping.
