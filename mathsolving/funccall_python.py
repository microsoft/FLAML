...
1. You can use Python to solve the problem directly if possible.
2. You can solve the problem by yourself, and try to use Python as a tool whenever possible during the solving process. For example, simplications, calculations, equation solving, enumerations, etc.
